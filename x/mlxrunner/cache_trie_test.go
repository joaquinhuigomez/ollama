...
func TestFindSplitAppendSequence(t *testing.T) {
	...
	split := splitNode(lastNode, matchedInEdge, nil)
...
func TestMergeWithChild(t *testing.T) {
	t.Run("Basic", func(t *testing.T) {
		...
		mergeWithChild(a, []cache.Cache{mc})
...
func TestSplitMergeRoundTrip(t *testing.T) {
	...
	newParent := splitNode(leaf, 3, caches)
	...
	mergeWithChild(newParent, caches)
